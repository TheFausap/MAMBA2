...
MAX_LENGTH = 128
TOKENIZED_DATASET_DIR = Path(f"tinystories_gpt2_tokenized_{MAX_LENGTH}")
...
BEST_CHECKPOINT_PATH = "mamba_tinystories_best.pt"
FINAL_CHECKPOINT_PATH = "mamba_tinystories.pt"
